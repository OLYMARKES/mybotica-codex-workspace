...
ASSETS = ROOT / "assets"
OUT = ROOT / "storyboards" / "chat-overload-v5"
OUT.mkdir(parents=True, exist_ok=True)
GEN_OUT = ROOT / "generation" / "chat-overload-v5"
...
def frame_1():
    ...
    paste_pose(im, 9, (80, 390, 1000, 1560))
...
def frame_2():
    ...
    paste_pose(im, 10, (410, 590, 1040, 1480))
...
def frame_3():
    ...
    paste_pose(im, 5, (205, 590, 875, 1430))
...
def frame_4():
    ...
    paste_pose(im, 6, (175, 555, 905, 1445))
...
def frame_5():
    ...
    paste_pose(im, 5, (520, 920, 1040, 1570))
...
def frame_6():
    ...
    paste_pose(im, 2, (655, 1330, 1035, 1800))
    return im


def frame_7():
    im, d = base(7, "0:12–0:14", "ТЕПЕРЬ МОЖНО ВЫДОХНУТЬ")
    paste_pose(im, 12, (90, 450, 990, 1550))
...
sheet.save(ROOT / "storyboard-chat-overload-v5.jpg", quality=95)
print(ROOT / "storyboard-chat-overload-v5.jpg")
