# MyBotica Cardboard — character bible v1
...
- Exactly three burgundy spikes on the head.
- One burgundy wing on the back-right side.
- Burgundy tail spikes and a curled tail.
- Dark-green edging and warm cream paper body.
- Visible paper fibres, hand-cut edges and brass joint fasteners.
- Palette only: `#0F2A24`, `#8C1D26`, `#F6F2EE`.
